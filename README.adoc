...
** link:labs/lab5/Spring_Boot_with_Spring_Data Rest.html#add-a-restful-api-with-spring-data-rest:3976528693a0108357f4928017600865[Lab 5 - Testing RESTful Services]